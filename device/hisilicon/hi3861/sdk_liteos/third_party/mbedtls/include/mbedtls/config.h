...
/*
 * accelerate RSA signature and veification by Hisilicon Cipher
 * please be aware that only the SHA256RSA2048 and SHA256RSA4096 could be accelerated.
 */
#define MBEDTLS_RSA_HW_ACCEL_BY_HI_CIPHER

/*
 * accelerate ECDSA signature and veification by Hisilicon Cipher
 * please be aware that only the SHA256SECP256R1 and SHA256SECP256K1 and SHA256BP256R1 could be accelerated.
 */
#define MBEDTLS_ECDSA_HW_ACCEL_BY_HI_CIPHER
