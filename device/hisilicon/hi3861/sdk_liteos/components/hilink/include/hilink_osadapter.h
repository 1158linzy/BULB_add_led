...
/*
 * 创建系统任务, 返回0成功，返回非0失败
 * 注意：Contiki OS 不支持该接口,任务优先级 level:mbed OS 固定传0,其他 OS 支持三个优先级, 含义及取值如下:
 * 优先级4：TASK_PRIORITY_LOW, 优先级3：TASK_PRIORITY_MIDDLE, 优先级2：TASK_PRIORITY_HIGH
 */
