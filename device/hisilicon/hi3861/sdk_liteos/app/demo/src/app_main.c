...
#include <hi_tsensor.h>
#ifdef HICHANNEL_SUPPORT
#include "hi_channel_dev.h"
#include "app_demo_channel.h"
...
static hi_void *sdio_reinit_task_body(hi_void *param)
{
...
hi_u32 app_sdio_reinit(hi_void)
{
    ...
    hi_u32 ret = hi_task_create(&sdio_init_task_id, &attr, sdio_reinit_task_body, HI_NULL);
...
hi_s32 hi_channel_init(hi_void)
{
    ...
    printf("Hichannel dev init SUCCESSFULLY\n");
    return HI_ERR_SUCCESS;
}
#endif /* HICHANNEL_SUPPORT */
