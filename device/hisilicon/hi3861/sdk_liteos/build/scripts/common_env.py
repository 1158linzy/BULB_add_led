...
proj_lib_cfg = {
    ...
    'boot':{ #module name
        'boot': [ #library name
            ...
            os.path.join('..', '..', 'third_party', 'u-boot-2020.01', 'u-boot-2020.01', 'lib'),
    ...
    'lwip':{
        'lwip':[
            os.path.join('arch'),
            os.path.join('api'),
            os.path.join('api', 'nettool'),
            os.path.join('core'),
            os.path.join('core', 'ipv4'),
            os.path.join('core', 'ipv6'),
            os.path.join('netif'),
            os.path.join('core', 'nat64'),
        ],
    },
    'wpa':{
        'wpa':['wpa_supplicant'],
        'wpa_src':['src', 'liteos_wpa_src', 'hostapd'],
        'wpa_hisi':['driver_hisi'],
    },
    'hilink':{'hilink':['.']},
    'OHOS':{
        'OHOS':[
...
proj_environment = {
    ...
    'defines':{
        ...
        'wpa':['INCLUDE_UNUSED', 'WLAN_HEADERS', 'WIRELESS_EXT=0', 'BT_SETUP=0', 'REGCODE_REMAPPING=0', 'SOFTAP_MODE',
            ...
            'CONFIG_DRIVER_HISILICON', 'LOS_WPA_PATCH', 'LOS_CONFIG_HOSTAPD_PMKSA_CROP', 'LOS_HOSTAPD_HT_CONFIG_CROP', 'LOS_HOSTAPD_CONFIG_CROP', 'LOS_CONFIG_ACL_CROP',
    ...
    'liteos_inc_path':{
        ...
        'wpa':[
            ...
            os.path.join('net', 'wpa_supplicant', 'liteos_wpa_src'),
            os.path.join('net', 'wpa_supplicant', 'driver_hisi'),
        ],
    },
...
macro_val = list(macro_cfg.keys())
set_config('env_cfg', macro, macro_val, macro_cfg, 'defines', 'common')
set_config('env_cfg', 'CONFIG_WPA3_AP_SUPPORT', 'y', ['CONFIG_SAE','CONFIG_HOSTAPD_WPA3', 'LOS_CONFIG_HOSTAPD_MGMT', 'CONFIG_HOSTAPD_WPA3_PMKSA',], 'defines', 'common')
...
set_config('env_cfg', 'CONFIG_OHOS', 'y', ['CONFIG_OHOS', ('HOS_PRODUCT_TYPE', r'\"\"'), ('HOS_SERIAL', r'\"\"'), ('HOS_MANUFACTURE', r'\"\"'),
    ...
    ('HOS_SECURITY_PATCH_TAG', r'\"\"'), ('HOS_ABI_LIST', r'\"\"'), ('HOS_INCREMENTAL_VERSION', r'\"OHOS_2.0.1.46\"'),
    ('HOS_BUILD_TYPE', r'\"release\"'), ('HOS_BUILD_USER', r'\"jenkins\"'), ('HOS_BUILD_TIME', r'\"2020-04-09_16:39:35\"'),
